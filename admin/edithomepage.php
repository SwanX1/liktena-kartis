...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$file = fopen("homepage.php", "w") or die("Radās kļūda, nevarēja saglabāt!");
	fwrite($file, $contents);
	fclose($file);
	header("Location: http://liktenakartis.ddns.net/admin/?action=start");
}
?>
...
<div class="row-padding grayscale">
	<div class="margin-bottom">
		<div class="light-grey container animate-zoom padding margin" align="center">
			...
			<textarea name="contents" style="width:100%; height:600px;"><?php echo htmlspecialchars(file_get_contents("homepage.php"));?></textarea>
			<div align="right">
